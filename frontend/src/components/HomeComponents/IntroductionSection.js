                ...
                <div className="list-container">
                    <div className="list">
                        <ul>
                            ...
                            <br></br>
                            <li><strong>Catalogue</strong> will take you to a table where filters will help you to find relevant organizations, discussion topics, assessment ideas and mini case studies (most being from non-profit organizations). </li>
                            <br></br>
