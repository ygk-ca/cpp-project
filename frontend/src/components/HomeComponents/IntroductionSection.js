    ...
    return (
        <section class="intro-container1">
            <div class="left-half">
                ...
                <div className="intro-title">About the Social Impact Learning Lab</div>
                <div className="para-text">Welcome to a program our team created to help instructional designers and instructors find inspiration or content to use in their curriculum. Our focus is on the 17 Sustainable Development Goals proposed by United Nations. <br></br><br></br>By incorporating these ideologies into your courses, you are becoming part of the un /......... as we strive to foster global change. Our Team has made the assessments accessible to you under the "Catalogue" tab to browse at your leisure.</div>
